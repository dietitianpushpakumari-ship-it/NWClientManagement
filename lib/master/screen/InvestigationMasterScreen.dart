...
import 'investigation_master_entry_dialog.dart';

class InvestigationMasterScreen extends ConsumerStatefulWidget {
  const InvestigationMasterScreen({super.key});

  @override
  ConsumerState<InvestigationMasterScreen> createState() => _InvestigationMasterScreenState();
}

class _InvestigationMasterScreenState extends ConsumerState<InvestigationMasterScreen> {
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<List<InvestigationMasterModel>>(
                stream: ref.watch(investigationMasterServiceProvider).getInvestigation(),
                builder: (context, snapshot) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildInvestigationCard(context, item);
                    },
                  );
                },
              ),
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: "Search investigation by name...",
  ...
  // 🎯 MODIFIED: Card Style
  Widget _buildInvestigationCard(BuildContext context, InvestigationMasterModel item) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(16),
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: Colors.blueAccent.withOpacity(.1), shape: BoxShape.circle), child: const Icon(Icons.science, color: Colors.blueAccent)),
            ],
          ),
        ),
      ),
