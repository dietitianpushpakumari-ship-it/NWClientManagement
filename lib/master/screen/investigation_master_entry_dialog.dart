...
class InvestigationMasterEntryDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<InvestigationMasterEntryDialog> createState() => _InvestigationMasterEntryDialogState();
}

class _InvestigationMasterEntryDialogState extends ConsumerState<InvestigationMasterEntryDialog> {
  ...
  void _saveInvestigation() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final savedRecord = await ref.read(investigationMasterServiceProvider).addOrUpdateInvestigation(investigationToSave);
