...
class _VitalsHistoryPageState extends State<VitalsHistoryPage> {
  ...
  void initState() {
    super.initState();
    // 🎯 FIX: Do not call setState in initState. Just assign the future.
  ...
  Future<void> _deleteRecord(VitalsModel record) async {
    ...
    if (confirm == true) {
      try {
        ...
        _refresh(); // This calls setState, which is fine here (after build)
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => VitalsEntryPage(
          ...
          onVitalsSaved: _refresh, // This callback calls setState, which is fine
