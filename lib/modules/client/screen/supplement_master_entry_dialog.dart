...
class SupplementationMasterEntryDialog extends StatefulWidget {
  ...
  @override
  State<SupplementationMasterEntryDialog> createState() => _SupplementationMasterEntryDialogState();
}

class _SupplementationMasterEntryDialogState extends State<SupplementationMasterEntryDialog> {
  ...
  void _saveSupplementation() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final savedRecord = await SupplimentMasterService().addOrUpdateSupplimentMaster(supplementationToSave);
